        ...
        for (Map.Entry<String, String[]> entry : searchMap.entrySet()) {
            ...
            try {
                ...
                if (filedAndOption.length == 2) {
                    ...
                    //比较
                    if (option.equals("lt")) {
                        specificationTmp = ExampleUtil.lt(filed, Integer.parseInt(value[0]));
                    }
                    if (option.equals("lte")) {
                        specificationTmp = ExampleUtil.lte(filed, (Comparable) value[0]);
                    }
                    if (option.equals("gt")) {
                        specificationTmp = ExampleUtil.gt(filed, Integer.parseInt(value[0]));
                    }
                    if (option.equals("gte")) {
                        specificationTmp = ExampleUtil.gte(filed, (Comparable) value[0]);
                    }
                    //模糊搜索
                    if (option.equals("like")) {
                        specificationTmp = ExampleUtil.like(filed, value[0]);
                    }
                    if (option.equals("lkS")) {
                        specificationTmp = ExampleUtil.likeStart(filed, value[0]);
                    }
                    if (option.equals("lkE")) {
                        specificationTmp = ExampleUtil.likeEnd(filed, value[0]);
                    }
                    if (option.equals("eq")) {
                        specificationTmp = ExampleUtil.eq(filed, value[0]);
                    }
                }
                if (filedAndOption.length == 1) {
                    specificationTmp = ExampleUtil.eq(key, value[0]);
                }
        ...
        for (Map.Entry<String, Object> entry : searchMap.entrySet()) {
            ...
            try {
                ...
                if (filedAndOption.length == 2) {
                    ...
                    //比较
                    if (option.equals("lt")) {
                        specificationTmp = ExampleUtil.lt(filed, Integer.parseInt((String) value));
                    }
                    if (option.equals("lte")) {
                        specificationTmp = ExampleUtil.lte(filed, (Comparable) value);
                    }
                    if (option.equals("gt")) {
                        specificationTmp = ExampleUtil.gt(filed, Integer.parseInt((String) value));
                    }
                    if (option.equals("gte")) {
                        specificationTmp = ExampleUtil.gte(filed, (Comparable) value);
                    }
                    //模糊搜索
                    if (option.equals("like")) {
                        specificationTmp = ExampleUtil.like(filed, (String) value);
                    }
                    if (option.equals("lkS")) {
                        specificationTmp = ExampleUtil.likeStart(filed, (String) value);
                    }
                    if (option.equals("lkE")) {
                        specificationTmp = ExampleUtil.likeEnd(filed, (String) value);
                    }
                    if (option.equals("eq")) {
                        specificationTmp = ExampleUtil.eq(filed, value);
                    }
                }
                if (filedAndOption.length == 1) {
                    specificationTmp = ExampleUtil.eq(key, value);
                }
